def create_php_file(file_path, content):
...
"""
new_php_file_path = 'application/views'

create_php_file(new_php_file_path, new_php_content)

def add_code_to_file(file_path, code_to_add):
    with open(file_path, 'a') as file:
        file.write(code_to_add)

code_for_main_controller = """
public function cheap_flight_a()
{
...
main_controller_file_path = 'application.com/controllers/maincontroller.php'
routes_file_path = 'application.com/config/routes.php'

# Call the function to add code to the existing PHP files
add_code_to_file(main_controller_file_path, code_for_main_controller)
add_code_to_file(routes_file_path, code_for_routes)