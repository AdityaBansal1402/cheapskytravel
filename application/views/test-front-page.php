<script>
   ...
   document.getElementsByTagName('meta')["description"].content = "Get Our Low Cost Flight Tickets on Cheapskytravel. Book Now to Save! Experience Fast, Easy & Secure Flight Booking on Cheapskytravel. Book Now! For Booking Call @ <?= TFN ?>.";
</script>
...
<p>We combine first-hand experience with fantastic deals, we take care of minor to small statistics, and we construct a vacation that is as unique as you are. As all of your needs are met under one roof at Cheapskytravel, you won't need to worry about arranging flight tickets any longer.</p>
...
<script>
$('.airline-name').text('Cheapskytravel.COM');
</script>
