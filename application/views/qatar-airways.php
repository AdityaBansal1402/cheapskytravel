<script>
document.title = "Book Cheap Flight Ticket on Qatar Airways | Get Cheap Flight Deal Qatar Airways - Cheapskytravel";       
 ...
 <?php include 'sm-inc.php'; ?>
   ...
   <div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
      <div class="container">
       ...
       <p>You may book inexpensive tickets on Qatar Airways, one of the most affordable carriers, with Cheapskytravel. So that you may take a comfortable flight without blowing your holiday budget, we can provide you access to exclusive deals. Be with our travel expert, get <strong>inexpensive flight tickets</strong>, and put an end to your frustration. You may benefit from our year-round accessibility and our special rates for solo, family, group, and business travel. Travel the world on a budget with a Cheapskytravel flying package. However, online airline booking implies that the rate does not include any additional operational costs or surcharges.</p>
<h3>About</h3>
