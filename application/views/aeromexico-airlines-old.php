...
<link rel="stylesheet" href="https://www.Cheapskytravel.com/frontend/bootsrap_V5/bootstrap.min.css">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Mexico City to Paris"
                     href="https://www.Cheapskytravel.com/Result?depart=MEX&arrival=CDG&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Mexico City to London"
                     href="https://www.Cheapskytravel.com/Result?depart=MEX&arrival=LHR&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                     <div class="row align-items-center no-gutters">
                        <div class="col-lg-8 col-8">
                           <div class="dd-box">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Los Angeles to Mexico City"
                     href="https://www.Cheapskytravel.com/Result?depart=LAX&arrival=MEX&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                     <div class="row align-items-center no-gutters">
                        <div class="col-lg-8 col-8">
                           <div class="dd-box">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Mexico City to New York"
                     href="https://www.Cheapskytravel.com/Result?depart=MEX&arrival=JFK&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                     <div class="row align-items-center no-gutters">
                        <div class="col-lg-8 col-8">
                           <div class="dd-box">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Mexico City to Las Vegas"
                     href="https://www.Cheapskytravel.com/Result?depart=MEX&arrival=LAS&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                     <div class="row align-items-center no-gutters">
                        <div class="col-lg-8 col-8">
                           <div class="dd-box">
            ...
            <div class="col-lg-4 col-md-6 col-12 form-group fdl">
               <div class="flight-status bxd">
                  <a onclick="nav()" title="Flight From Mexico City to Orlando"
                     href="https://www.Cheapskytravel.com/Result?depart=MEX&arrival=MCO&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                     <div class="row align-items-center no-gutters">
                        <div class="col-lg-8 col-8">
                           <div class="dd-box">
   ...
   <div class="about-spirit-airlines content-wrap my-5">
      <div class="container">
         ...
         <p>Aeromexico serves its <strong>cheap flight journeys</strong> to over 87 locations including multiple cities
            ...
            the Cheapskytravel team. Reach us at <?=TFN?> and enjoy <strong>affordable flight deals</strong> to your
...
<script src="https://www.Cheapskytravel.com/frontend/bootsrap_V5/bootstrap.bundle.min.js"></script>
<style>
   .tfn-bottom-section {
