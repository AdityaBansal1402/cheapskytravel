...
<h4>Top Airlines</h4>
<img onclick="window.location.href='<?= base_url() ?>'" src="<?= base_url() ?>frontend/images/logo.png" alt="Cheapskytravel logo"/>
</div>
...
<div class="container">
 <p>Cheapskytravel its registered office located at Address:117 Windwoods Drive, Collegeville PA 19426, in the state of Pennsylvania (USA).  We are available to provide customer support on all days from Monday to Sunday. Customer Service Number: <?= TFN ?> | Email: <?= EMAIL ?> © Copyrights 2023. <?= WEBSITE ?>.</p>      
